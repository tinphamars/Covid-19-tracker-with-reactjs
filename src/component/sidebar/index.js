    ...
    return (
        <div className="d-flex flex-column align-items-stretch flex-shrink-0 bg-white side-bar">
            ...
            <div className="list-group list-group-flush border-bottom scrollarea">
                {data.map((item) =>
                    <a key={item.CountryCode} ref={el => refs.current[item.CountryCode] = el} href="#" className={(item.CountryCode === active ? "active" : "") + " list-group-item list-group-item-action py-3 lh-tight"}>
